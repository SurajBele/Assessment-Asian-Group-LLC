...
5. Verify load balancing
    * Open a web browser and navigate to http://localhost. Refresh the page multiple times, and you should see the requests being distributed between the two backend servers.
